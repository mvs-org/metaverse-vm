...
use betelgeuse_primitives::{Difficulty, AlgorithmApi};
	...
	C::Api: DifficultyApi<B, Difficulty> + AlgorithmApi<B>,
{
	...
	fn verify(
		...
		let version = match version_raw {
			betelgeuse_primitives::ALGORITHM_IDENTIFIER_V1 => RandomXAlgorithmVersion::V1,
			betelgeuse_primitives::ALGORITHM_IDENTIFIER_V2 => RandomXAlgorithmVersion::V2,
