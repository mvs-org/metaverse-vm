...
// --- hyperspace ---
use crate::{self as hyperspace_balances, pallet::*};
		...
		.execute_with(|| {
			...
			assert_eq!(
				...
				[
					...
					Event::hyperspace_balances_Instance0(hyperspace_balances::Event::BalanceSet(
						1, 100, 0
					)),
				]
			);
			...
			assert_eq!(
				...
				[
					...
					Event::hyperspace_balances_Instance0(hyperspace_balances::Event::DustLost(1, 1))
				]
			);
		});
}
...
fn dust_collector_should_work() {
	<ExtBuilder>::default()
		...
		.execute_with(|| {
			...
			assert_ok!(Etp::set_balance(RawOrigin::Root.into(), 1, 100, 0));
			assert_ok!(Dna::set_balance(RawOrigin::Root.into(), 1, 100, 0));
			...
			assert_eq!(
				...
				[
					...
					Event::hyperspace_balances_Instance1(hyperspace_balances::Event::Endowed(1, 100)),
					Event::hyperspace_balances_Instance1(hyperspace_balances::Event::BalanceSet(
						1, 100, 0
					)),
				]
			);
			...
			assert_eq!(
				...
				[
					Event::frame_system(frame_system::Event::KilledAccount(1)),
					Event::hyperspace_balances_Instance0(hyperspace_balances::Event::DustLost(1, 99)),
					Event::hyperspace_balances_Instance1(hyperspace_balances::Event::DustLost(1, 99)),
				]
			);
		});
}
