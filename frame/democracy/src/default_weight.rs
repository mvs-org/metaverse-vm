...
impl crate::WeightInfo for () {
	...
	fn external_propose_majority() -> Weight {
		(5_030_000 as Weight).saturating_add(DbWeight::get().writes(1 as Weight))
	}
	fn external_propose_default() -> Weight {
		(4_981_000 as Weight).saturating_add(DbWeight::get().writes(1 as Weight))
	}
	...
	fn cancel_referendum() -> Weight {
		(25_233_000 as Weight).saturating_add(DbWeight::get().writes(1 as Weight))
	}
	...
	fn clear_public_proposals() -> Weight {
		(4_864_000 as Weight).saturating_add(DbWeight::get().writes(1 as Weight))
	}
