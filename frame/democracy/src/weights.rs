...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn external_propose_majority() -> Weight {
		(4_413_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn external_propose_default() -> Weight {
		(4_365_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn fast_track() -> Weight {
	...
	fn cancel_referendum() -> Weight {
		(22_971_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	...
	fn clear_public_proposals() -> Weight {
		(4_071_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
...
impl WeightInfo for () {
	...
	fn external_propose_majority() -> Weight {
		(4_413_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
	fn external_propose_default() -> Weight {
		(4_365_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
	fn fast_track() -> Weight {
		(37_914_000 as Weight)
			.saturating_add(RocksDbWeight::get().reads(2 as Weight))
	...
	fn cancel_referendum() -> Weight {
		(22_971_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
	fn cancel_queued(r: u32) -> Weight {
		(41_431_000 as Weight)
			.saturating_add((4_598_000 as Weight).saturating_mul(r as Weight))
	...
	fn clear_public_proposals() -> Weight {
		(4_071_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
	fn note_preimage(b: u32) -> Weight {
		(58_361_000 as Weight)
			.saturating_add((4_000 as Weight).saturating_mul(b as Weight))
