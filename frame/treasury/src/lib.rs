...
decl_storage! {
	trait Store for Module<T: Trait<I>, I: Instance = DefaultInstance> as HyperspaceTreasury {
...
impl<T: Trait<I>, I: Instance> OnUnbalanced<EtpNegativeImbalance<T, I>> for Module<T, I> {
