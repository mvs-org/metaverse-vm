//! The Betelgeuse runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
use sp_runtime::traits::{
	...
	NumberFor, Verify, IdentifyAccount, Convert, ConvertInto,
};
use sp_api::impl_runtime_apis;
use sp_version::RuntimeVersion;
#[cfg(feature = "std")]
use sp_version::NativeVersion;
use betelgeuse_primitives::{DOLLARS, CENTS, MILLICENTS, MICROCENTS, HOURS, DAYS, BLOCK_TIME, deposit};
...
pub use frame_support::{
	...
	traits::{Currency, Randomness, LockIdentifier, OnUnbalanced, KeyOwnerProofSystem, InstanceFilter},
	weights::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("betelgeuse"),
	impl_name: create_runtime_str!("betelgeuse"),
	authoring_version: 5,
	spec_version: 13,
	impl_version: 0,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		//GRANDPA
		Grandpa: pallet_grandpa::{Module, Call, Storage, Config, Event, ValidateUnsigned} = 30,
		//Historical: pallet_session_historical::{Module} = 31,
		//Offences: pallet_offences::{Module, Call, Storage, Event} = 32,
	}
);
...
impl_runtime_apis! {
	...
	impl sp_consensus_pow::DifficultyApi<Block, betelgeuse_primitives::Difficulty> for Runtime {
		fn difficulty() -> betelgeuse_primitives::Difficulty {
...
//	}
	...
	impl betelgeuse_primitives::AlgorithmApi<Block> for Runtime {
		fn identifier() -> [u8; 8] {
			betelgeuse_primitives::ALGORITHM_IDENTIFIER_V2
		}
	}
