...
use betelgeuse_primitives::CENTS;
...
impl WeightToFeePolynomial for WeightToFee {
	...
	fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
		// in Betelgeuse, extrinsic base weight (smallest non-zero weight) is mapped to 1/10 CENT:
		let p = CENTS;
...
mod tests {
	...
	use betelgeuse_primitives::{CENTS, DOLLARS};
