...
"method":"state\_getRuntimeVersion", "params":\[\]}'
...
**author\_hasKey** (*public\_key: Bytes, key\_type: String*)
...
**author\_insertKey** (*key\_type: String,suri: String, public: Bytes*)
...
**author\_removeExtrinsic **(*bytes\_or\_hash:
Vec\<hash::ExtrinsicOrHash\<Hash\>\>*)
...
**chain\_subscribeAllHeads** (*metadata: Self::Metadata, *
...
New runtime version subscription alias of state\_subscribeRuntimeVersion
...
***chain\_unsubscribeRuntimeVersion****(**metadata:
...
**state\_getStorageSizeAt** (*key: StorageKey, *
...
**state\_unsubscribeRuntimeVersion** (*metadata:
Option\<Self::Metadata\>, *
...
**Unsubscribe from new head subscription**(*metadata:
Option\<Self::Metadata\>,*
